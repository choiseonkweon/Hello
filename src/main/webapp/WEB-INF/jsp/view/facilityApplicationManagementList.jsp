...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog">
								        ...
								        <tr>
								          ...
								          <td><span id="useDate" class="view"></span>
												<div class="set modify">
													<input type="text" class="input-sm" data-dateformat="yyyy-mm-dd" id="useFrDt" name="useFrDt" readonly="readonly" value="" style="width: 110px; margin-right: 4px;" />
	...
	<script type="text/javaScript" >
        ...
        function fn_egov_link_page(pageNo){
        	...
        	document.listForm.action = "<c:url value='/facility/facilityApplicationManagementList.do'/>";
